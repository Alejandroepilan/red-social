...
export function Sidebar() {
  ...
  return (
    <aside
      id="default-sidebar"
      className="fixed flex-initial top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidenav"
    >
        ...
        <ul className="pb-5 mb-5 space-y-2 border-b border-gray-200">
          <li>
            <a className="flex items-center p-2 text-base font-normal text-gray-900 group">
              <span className="ml-3">Bienvenido, {user.username}</span>
            </a>
          </li>
        </ul>
